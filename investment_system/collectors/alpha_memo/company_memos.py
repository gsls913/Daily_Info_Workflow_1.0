...
================================
用法:
  python investment_system.collectors.alpha_memo/company_memos.py
  python investment_system.collectors.alpha_memo/company_memos.py --stock 601888.SH --name 中国中免
...
from investment_system.common.utils.paths import PROJECT_ROOT, CREDENTIALS_DIR, TOKEN_FILE, ALPHAPAI_INFO_FILE, MEMO_BASE_DIR, COMPANY_MEMO_HISTORY_FILE
...
# 主流程
# ============================================================
def download_memos_for_stock(stock_code, company_name="", max_count=None):
    log_info("\n" + "=" * 70)
...
def main():
    ...
    parser.add_argument('--count', type=int, default=None, help='最多下载靠前的 N 篇；不填则下载全部能下载的纪要')
    ...
    downloaded_count, total_count, downloaded_files = download_memos_for_stock(stock_code, company_name, max_count=args.count)
